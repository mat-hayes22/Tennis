...
#line 28
 testRunner.When(string.Format("A Player {0} scores", whichPlayer), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 29
 testRunner.Then(string.Format("{0} will have the score {1}", whichPlayer, score), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
